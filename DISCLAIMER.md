# Disclaimer & Acceptable Use — insane-research

`insane-research` is part of the [gptaku-plugins](https://github.com/fivetaku/gptaku_plugins)
...
`insane-research` is a general-purpose developer tool. Like most general-purpose tools, it
